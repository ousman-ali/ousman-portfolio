  ...
  return (
    <aside className={showOpen ? "sidebar" : "sidebar in-active"}>
      <div className="profile">
        ...
        <p className="bio">
          Hi, I'm <span>Ousman Ali</span>, a passionate full stack web and
      ...
      <div className="breakLine">
        ...
        {showOpen ? (
          <button onClick={() => setShowOpen(!showOpen)} className="showButton">
            <span>Show Less</span>
        ...
        <>
          <div className="connectLinks">
            ...
            <div className="connectIcon">
              ...
              <span>Saris | Addis Ababa | ET</span>
            </div>
          </div>
          ...
          <nav className="social-links">
            ...
            <div className="socials">
              <a
                href="https://github.com/ousman-ali"
                target="_blank"
                rel="noreferrer"
                aria-label="GitHub"
              >
              ...
              <a
                href="https://www.linkedin.com/in/ousman-ali-8271182b3"
                target="_blank"
                rel="noreferrer"
                aria-label="LinkedIn"
              >
              ...
              <a
                href="https://instagram.com/ousman.8100"
                target="_blank"
                rel="noreferrer"
                aria-label="Twitter"
              >
